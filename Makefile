...
SOURCES= src/OS.cpp src/Window.cpp src/ConfigSystem.cpp  \
	...
	src/Scene.cpp src/Graphics/GLContext.cpp src/Graphics/GLAPI.cpp
...
vilo-game: main.cpp lib ;$(CC) $(CCFLAGS) $(LDFLAGS)  main.cpp -o $(OUT) $(LIB)
lib: $(DEPS) $(OBJ) $(LDFLAGS) ;rm $(LIB); ar -q $(LIB) $(OBJ); ar -s $(LIB)

.cpp.o: $(DEPS) ; $(CC) -c $(CCFLAGS) $(LDFLAGS)  $< -o $@

clean: ; rm src/*.o; rm src/LuaWrap/*.o; rm src/Graphics/*.o
